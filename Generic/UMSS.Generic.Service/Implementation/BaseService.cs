...
namespace UMSS.Generic.Service.Implementation
{
    public abstract class BaseService<TEntity,TModel> : IBaseService<TEntity,TModel> where TEntity : BaseEntity where TModel : BaseModel
    {
        ...
        private readonly IBaseRepository<TEntity, TModel> _entityRepository;
        private readonly ILogger _logger;
        public BaseService
        (
            IUnitOfWork unitOfWork, IBaseRepository<TEntity, TModel> entityRepository
            , ILogger logger)
        {
